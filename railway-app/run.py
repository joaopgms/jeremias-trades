...
def generate_data_js(history_json: str, draft_picks: list, scout_model_output: str = "", scout_error: str = "") -> str:
...
Use web_search for all research. Output the updated files using the XML tags at the end."""
    ...
    if not updated_state or not updated_history:
        ...
        data_js = generate_data_js(history_json, draft_picks, state_obj["scout_model_output"], state_obj["scout_error"])
    ...
    data_js = generate_data_js(updated_history, draft_picks, state_obj["scout_model_output"], state_obj["scout_error"])
